                ...
                function getNetworkStatus() {
                    ...
                    if (isPluginAvailable) {
                        ...
                        if (navigator.connection.type.toLowerCase() == 'unknown') {
                            ...
                            if ($cordovaNetwork) return $cordovaNetwork.isOnline();
                            else return true;
                            //return typeof $cordovaNetwork === 'undefined' ||  typeof $cordovaNetwork.isOnline() === 'undefined'? true : $cordovaNetwork.isOnline();
                        }
                    }
